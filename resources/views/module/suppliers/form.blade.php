		...
		<div class="box box-primary ">
			...
			<div class="box-body">
				...
				{!! form_start($form) !!}
					...
					<div class="col-md-8">
                        {!! form_row($form->name_company, ['default_value' => isset($row) ? $row->name_company: '']) !!}
                        {!! form_row($form->handphone, ['default_value' => isset($row) ? $row->handphone: '']) !!}
												{!! form_row($form->telp, ['default_value' => isset($row) ? $row->telp: '']) !!}
												{!! form_row($form->email, ['default_value' => isset($row) ? $row->email: '']) !!}
												{!! form_row($form->website, ['default_value' => isset($row) ? $row->website: '']) !!}
                        {!! form_row($form->active) !!}
												{!! form_row($form->address, ['default_value' => isset($row) ? $row->address: '']) !!}
					</div>
					<div class="col-md-4">
